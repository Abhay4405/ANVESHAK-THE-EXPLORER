...
import 'person_details.dart'; // Renamed from child_auth.dart
...
class Routes {
  ...
  static const personDetails = '/personDetails'; // Renamed route
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      routes: {
        ...
        Routes.personDetails: (context) => const PersonDetailsPage(), // Updated
